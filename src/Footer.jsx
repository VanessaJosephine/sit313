    ...
    return (
        <div>
            <div className="footer">
                ...
                {/*</div>*/}
                {/*<div className="right">*/}
                {/*    <a href="https://www.facebook.com/DeakinUniversity"><BsFacebook className="icons"/></a>*/}
                {/*    <a href="https://www.instagram.com/deakinuniversity"><FiInstagram className="icons"/></a>*/}
                {/*    <a href="https://www.twitter.com/Deakin"><AiFillTwitterCircle className="icons"/></a>*/}
                {/*</div>*/}
                <div className="mid">
                    <div className="left">
